...
void MainWindow::on_comboBox_currentIndexChanged(QString index)
{
            ...
            {
                        ui->label_sinif->setText(tr("Dosya açýlmadý!"));
                        return;
            }
            ...
            while (!in1.atEnd())
            {
                        //                        QString line1 = in1.readLine().trimmed().toUpper();
                        QString line1 = in1.readLine().trimmed();
...
void MainWindow::timer2()
{
        ...
        */
            ...
            //                                       tr(" soru kalmýþtýr. "));
            //            ui->statusBar->showMessage( tr("Listede  %1 öðrenci ve %2 soru kalmýþtýr. ").arg(kalan_eleman_sayisi).arg(kalan_soru_sayisi) );

            ui->statusBar->showMessage( tr("Listede  %1 soru kalmýþtýr. ").arg(kalan_eleman_sayisi) );
}
...
bool MainWindow::eventFilter(QObject *watched, QEvent *e)
{
            if (e->type() == QEvent::KeyPress) {
                        ...
                        if (ke->key() == Qt::Key_Space) {
                                    ...
                                    ui->secButton->animateClick();
                                    on_secButton_clicked();
                                    return true;
                        }
            }
